...
from catalyst.pipeline.visualize import display_graph
...
class TermGraph(object):
    ...
    def _decref_depencies_recursive(self, term, refcounts, garbage):
        ...
        should use:
        :meth:`~catalyst.pipeline.graph.TermGraph.decref_dependencies`
        """
...
class ExecutionPlan(TermGraph):
    ...
    def offset(self):
        ...
        See Also
        --------
        catalyst.pipeline.graph.TermGraph.offset
        catalyst.pipeline.engine.SimplePipelineEngine._inputs_for_term
        catalyst.pipeline.engine.SimplePipelineEngine._mask_and_dates_for_term
        """
    ...
    def extra_rows(self):
        ...
        **as an input**.  This is not to be confused with `term.dependencies`,
        ...
        --------
        catalyst.pipeline.graph.TermGraph.offset
        catalyst.pipeline.term.Term.dependencies
        """
        return {
