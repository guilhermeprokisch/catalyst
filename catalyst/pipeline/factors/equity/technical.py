...
from catalyst.utils.input_validation import expect_bounded, expect_types
...
class BollingerBands(CustomFactor):
    ...
    **Default Inputs:** :data:`catalyst.pipeline.data.USEquityPricing.close`
...
class FastStochasticOscillator(CustomFactor):
    ...
    **Default Inputs:** :data: `catalyst.pipeline.data.USEquityPricing.close`
                        :data: `catalyst.pipeline.data.USEquityPricing.low`
                        :data: `catalyst.pipeline.data.USEquityPricing.high`
...
class IchimokuKinkoHyo(CustomFactor):
    ...
    **Default Inputs:** :data:`catalyst.pipeline.data.USEquityPricing.high`
                        :data:`catalyst.pipeline.data.USEquityPricing.low`
                        :data:`catalyst.pipeline.data.USEquityPricing.close`
...
class AnnualizedVolatility(CustomFactor):
    ...
    **Default Inputs:** :data:`catalyst.pipeline.factors.Returns(window_length=2)`  # noqa
