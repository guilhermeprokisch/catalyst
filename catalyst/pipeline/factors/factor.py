...
class Factor(RestrictedDTypeMixin, ComputableTerm):
    ...
    def zscore(self, mask=NotSpecified, groupby=NotSpecified):
        ...
        Returns
        -------
        zscored : catalyst.pipeline.Factor
        ...
        Examples
        --------
        See :meth:`~catalyst.pipeline.factors.Factor.demean` for an in-depth
    ...
    def rank(self,
        ...
        Returns
        -------
        ranks : catalyst.pipeline.factors.Rank
        ...
        :class:`catalyst.pipeline.factors.factor.Rank`
        """
    ...
    def pearsonr(self, target, correlation_length, mask=NotSpecified):
        ...
        Parameters
        ----------
        target : catalyst.pipeline.Term with a numeric dtype
        ...
        Returns
        -------
        correlations : catalyst.pipeline.factors.RollingPearson
    ...
    def spearmanr(self, target, correlation_length, mask=NotSpecified):
        ...
        Returns
        -------
        correlations : catalyst.pipeline.factors.RollingSpearman
            A new Factor that will compute correlations between `target` and
            the columns of `self`.
    ...
    def linear_regression(self, target, regression_length, mask=NotSpecified):
        ...
        Returns
        -------
        regressions : catalyst.pipeline.factors.RollingLinearRegression
    ...
    def winsorize(self,
        ...
        Returns
        -------
        winsorized : catalyst.pipeline.Factor
    ...
    def quartiles(self, mask=NotSpecified):
        ...
        Returns
        -------
        quartiles : catalyst.pipeline.classifiers.Quantiles
    ...
    def quintiles(self, mask=NotSpecified):
        ...
        Returns
        -------
        quintiles : catalyst.pipeline.classifiers.Quantiles
    ...
    def deciles(self, mask=NotSpecified):
        ...
        Returns
        -------
        deciles : catalyst.pipeline.classifiers.Quantiles
    ...
    def bottom(self, N, mask=NotSpecified, groupby=NotSpecified):
        ...
        Returns
        -------
        filter : catalyst.pipeline.Filter
        """
    ...
    def percentile_between(self,
        ...
        Returns
        -------
        out : catalyst.pipeline.filters.PercentileFilter
            A new filter that will compute the specified percentile-range mask.

        See Also
        --------
        catalyst.pipeline.filters.filter.PercentileFilter
        """
    ...
    def isnan(self):
        ...
        Returns
        -------
        nanfilter : catalyst.pipeline.filters.Filter
        """
        return self != self
...
class GroupedRowTransform(Factor):
    ...
    See Also
    --------
    catalyst.pipeline.factors.Factor.zscore
    catalyst.pipeline.factors.Factor.demean
    catalyst.pipeline.factors.Factor.rank
    """
    window_length = 0
...
class Rank(SingleInputMixin, Factor):
    ...
    Parameters
    ----------
    factor : catalyst.pipeline.factors.Factor
