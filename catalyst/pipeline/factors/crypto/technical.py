...
class BollingerBands(CustomFactor):
    ...
    **Default Inputs:** :data:`catalyst.pipeline.data.CryptoPricing.close`
...
class FastStochasticOscillator(CustomFactor):
    ...
    **Default Inputs:** :data: `catalyst.pipeline.data.CryptoPricing.close`
                        :data: `catalyst.pipeline.data.CryptoPricing.low`
                        :data: `catalyst.pipeline.data.CryptoPricing.high`
...
class IchimokuKinkoHyo(CustomFactor):
    ...
    **Default Inputs:** :data:`catalyst.pipeline.data.CryptoPricing.high`
                        :data:`catalyst.pipeline.data.CryptoPricing.low`
                        :data:`catalyst.pipeline.data.CryptoPricing.close`
