...
This module (catalyst.pipeline.loaders.blaze) exports a function called
...
from catalyst.pipeline.data.dataset import DataSet, Column
...
from catalyst.lib.adjusted_array import AdjustedArray, can_represent_dtype
from catalyst.lib.adjustment import make_adjustment_from_indices, OVERWRITE
...
from catalyst.utils.pool import SequentialPool
...
class BlazeLoader(dict):
    ...
    See Also
    --------
    :class:`catalyst.utils.pool.SequentialPool`
