...
from catalyst.pipeline.term import (
    AssetExists,
    LoadableTerm,
    validate_dtype,
)
from catalyst.utils.input_validation import ensure_dtype
from catalyst.utils.numpy_utils import NoDefaultMissingValue
...
class BoundColumn(LoadableTerm):
    ...
    latest : catalyst.pipeline.data.Factor or catalyst.pipeline.data.Filter
    ...
    dataset : catalyst.pipeline.data.DataSet
