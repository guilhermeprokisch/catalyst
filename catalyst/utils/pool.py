...
class ApplyAsyncResult(object):
    ...
    :meth:`~catalyst.utils.pool.SequentialPool.apply_async`.
    ...
    def wait(self):
        ...
        Notes
        -----
        In the :class:`~catalyst.utils.pool.SequentialPool` case, this is a nop
        because the function is computed eagerly in the same thread as the
        call to :meth:`~catalyst.utils.pool.SequentialPool.apply_async`.
        """
        pass
